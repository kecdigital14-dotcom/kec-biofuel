...
import { ChevronDown, ChevronRight, Beaker, Leaf, Factory, Zap } from 'lucide-react';

const RandDSectionOne = () => {
  const [expandedRow, setExpandedRow] = useState(null);

  const feedstocks = [
    { name: "Napier Grass", icon: <Leaf className="w-6 h-6" />, description: "High-yield, fast-growing energy crop with superior biogas potential", color: "bg-gradient-to-br from-green-400 to-green-600", bgColor: "bg-gradient-to-br from-green-50 to-green-100", row: 0 },
    { name: "Press Mud", icon: <Factory className="w-6 h-6" />, description: "Sugar industry by-product rich in organic matter for anaerobic digestion", color: "bg-gradient-to-br from-amber-400 to-orange-500", bgColor: "bg-gradient-to-br from-amber-50 to-orange-100", row: 0 },
    { name: "Cow Dung", icon: <Leaf className="w-6 h-6" />, description: "Traditional biomass source enhancing microbial activity", color: "bg-gradient-to-br from-emerald-400 to-teal-500", bgColor: "bg-gradient-to-br from-emerald-50 to-teal-100", row: 0 },
    { name: "Mother Liquor", icon: <Beaker className="w-6 h-6" />, description: "Nutrient-rich residual liquid supporting microbial balance", color: "bg-gradient-to-br from-cyan-400 to-blue-500", bgColor: "bg-gradient-to-br from-cyan-50 to-blue-100", row: 1 },
    { name: "DAF Sludge", icon: <Factory className="w-6 h-6" />, description: "Organic-rich industrial residue contributing to higher gas yields", color: "bg-gradient-to-br from-purple-400 to-indigo-500", bgColor: "bg-gradient-to-br from-purple-50 to-indigo-100", row: 1 }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-emerald-50 to-teal-100 ">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-green-800 via-emerald-700 to-teal-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="text-center">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 drop-shadow-lg">
              KEC AGRITECH PVT. LTD.
            </h1>
            <p className="text-base sm:text-lg text-green-100 mb-2 sm:mb-4 font-semibold">
              R&D BULANDSHAHR / KEC TECHNICAL
            </p>
            <p className="text-sm sm:text-base md:text-lg text-emerald-200 mb-6 sm:mb-8">
              July 22, 2021 - Biogas Research & Development Report
            </p>
            <div className="inline-flex items-center text-sm sm:text-base bg-gradient-to-r from-green-400 to-emerald-500 backdrop-blur-sm rounded-full px-4 sm:px-8 py-2 sm:py-4 text-white shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-green-700 to-emerald-600 bg-clip-text text-transparent mb-2">
            Research & Development Facility
          </h2>
          <p className="text-sm sm:text-base text-gray-500 max-w-2xl sm:max-w-4xl mx-auto leading-relaxed">
        ...
        {/* Feedstock Section */}
        <div className="bg-gradient-to-br from-white to-green-50 rounded-2xl shadow-xl p-4 sm:p-8 border border-green-100 mt-8">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-green-700 to-emerald-600 bg-clip-text text-transparent mb-6 text-center">
            Multi-Feedstock Approach
          </h3>

          {/* First Row */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-6">
            {feedstocks.filter(f => f.row === 0).map((feedstock, idx) => (
              <div
                key={idx}
                className={`${feedstock.bgColor} rounded-xl p-4 sm:p-6 hover:shadow-lg transition-all duration-300 cursor-pointer`}
              ...
              >
                ...
                {isRowExpanded(0) && (
                  <p className="text-gray-500 text-sm leading-relaxed font-sans">{feedstock.description}</p>
                )}
              </div>
            ))}
          </div>
