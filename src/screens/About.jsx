...
const OurBackground = dynamic(() => import('@/app/Components/OurBackground'), { ssr: false, loading: () => <LazyLoader /> });
const PMCServices = dynamic(() => import('@/app/Components/PMCServices'), { ssr: false, loading: () => <LazyLoader /> });
const Technologies = dynamic(() => import('@/app/Components/Technologies'), { ssr: false, loading: () => <LazyLoader /> });
const TurkeySolutions = dynamic(() => import('@/app/Components/TurkeySolutions'), { ssr: false, loading: () => <LazyLoader /> });
      ...
      <HeroBanner backgroundImage="/images/bannernew14.jpg">
        <div className="bg-black/5 backdrop-blur-md rounded-xl px-8 py-4 max-w-sm mx-auto text-center shadow-sm space-y-2">
          ...
          <h1 className="text-5xl md:text-5xl font-extrabold tracking-tight leading-tight text-white/80">
            KEC <span className="text-green-600">Bio-fuel</span> <span className="text-cyan-400"></span>
          </h1>
