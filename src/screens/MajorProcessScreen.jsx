...
const MajorProcess = dynamic(() => import('@/app/Components/MajorProcess'), { ssr: false, loading: () => <LazyLoader /> });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      <HeroBanner backgroundImage="/images/bannernew2.png">
        <div className="bg-black/5 backdrop-blur-md rounded-xl px-3 py-4 max-w-sm mx-auto text-center shadow-sm space-y-2">

          {/* Title */}
          <h1 className="text-5xl md:text-[45px] font-extrabold tracking-tight leading-tight text-white/80">
            Major Process <span className="text-green-600">Involved</span> <span className="text-cyan-400"></span>
          </h1>
