    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-gray-900/95 to-black/95 backdrop-blur-xl border border-green-400/30 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                ...
                <button className="group inline-flex items-center justify-center px-8 py-5 text-green-400 font-bold bg-transparent border-2 border-green-400/50 rounded-2xl hover:bg-green-400/10 hover:border-green-400 transition-all duration-300">
